...
CREATE TABLE `conflits` (
	...
	`conflit_autor_name` VARCHAR(100) NULL DEFAULT NULL COLLATE 'utf8mb4_general_ci',
	`conflit_autor_age` INT(11) NULL DEFAULT NULL,
	`conflit_defedant_name` VARCHAR(100) NULL DEFAULT NULL COLLATE 'utf8mb4_general_ci',
	`conflit_defedant_age` INT(11) NULL DEFAULT NULL,
	`conflit_draw` ENUM('improcedente','parcial','procedente') NULL DEFAULT NULL COLLATE 'utf8mb4_general_ci',
